...
CREATE TABLE `t_doubt`  (
  ...
  `studentDoubt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `studentId`(`studentId`) USING BTREE,
  CONSTRAINT `t_doubt_ibfk_1` FOREIGN KEY (`studentId`) REFERENCES `t_student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- ----------------------------
INSERT INTO `t_student` VALUES (9, '2015051036', '韩旭', '男', 16, '2015级', '2015051036', '2019-05-25 00:03:58', '17800001000', '1479885217@qq.com');
INSERT INTO `t_student` VALUES (15, '2015051037', '覃颖', '女', 4, '2014级', 'admin', '2018-04-12 13:45:41', '17888882888', 'fdasf5646@fox.com');
INSERT INTO `t_student` VALUES (16, '2015051039', '程洪', '男', 16, '2015级', '2015051039', '2021-04-18 14:54:07', '18381054146', '1261780252@qq.com');
INSERT INTO `t_student` VALUES (17, '2015051038', '谭力', '男', 10, '2013级', '2015051038', '2018-04-16 10:43:35', '17300000000', '359746845@qq.com');
...
INSERT INTO `t_student` VALUES (20, '2021010101', '赵新', '男', 16, '2021级', 'admin', '2021-04-26 17:27:59', '17712345678', '17712345678@163.com');
...
CREATE TABLE `t_student_opening_report_task_book`  (
  ...
  `studentKeXingXing` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `studentXuQiu` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `studentGaiYao` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `studentShuJuKu` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `description` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `completion` int(1) NULL DEFAULT NULL COMMENT '1-未通过  2-通过',
  `openscore` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `kexingscore` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `xuqiuscore` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `gaiyaoscore` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shujukuscore` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `studentId`(`studentId`) USING BTREE,
...
INSERT INTO `t_student_opening_report_task_book` VALUES (12, 9, 'E:\\BSM\\student\\9\\unintall.log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_teacher`  (
  ...
  `phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `email` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `zhicheng` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `departmentId`(`departmentId`) USING BTREE,
...
INSERT INTO `t_teacher` VALUES (13, '313', '1312', 25, '男', 'admin', '2021-03-06 17:22:46', '13312331234', '13312331234@163.com', '教授');
...
CREATE TABLE `t_teacher_opening_report_task_book`  (
  ...
  `keXingXing` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `xuQiu` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `gaiYao` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shuJuKu` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `description` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_thesis_information` VALUES (8, 9, 'E:\\BSM\\student\\9\\142001毕业论文.docx', 1, NULL);
INSERT INTO `t_thesis_information` VALUES (9, 16, 'E:\\BSM\\student\\16\\毕设论文.doc', 2, NULL);
INSERT INTO `t_thesis_information` VALUES (10, 16, 'E:\\BSM\\student\\16\\方案.docx', 2, NULL);
...
CREATE TABLE `t_thesis_title`  (
  ...
  `inputMan` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `nandu` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `liang` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `from` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `t_thesis_title` VALUES (15, '商城', 12, '2019-04-23 10:08:02', 2, '徐虹', '适中', '适中', '教师自拟', '设计开发', '发送方法');
...
INSERT INTO `t_user` VALUES (36, '313', '6666', 2);
INSERT INTO `t_user` VALUES (37, '2021010101', '123456', 1);
...
CREATE TABLE `t_zhiyuan`  (
  ...
  INDEX `thesisId`(`thesisId`) USING BTREE,
  INDEX `studentId`(`studentId`) USING BTREE,
  CONSTRAINT `t_zhiyuan_ibfk_1` FOREIGN KEY (`thesisId`) REFERENCES `t_thesis_title` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `t_zhiyuan_ibfk_2` FOREIGN KEY (`studentId`) REFERENCES `t_student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
