	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	    	<ul class="nav navbar-nav">
	        	<li><a href="#">公告查看</a></li>
	       		<li><a href="#">文件下载</a></li>
	       		<li><a href="#">答疑解惑</a></li>
				<li><a href="${pageContext.request.contextPath}/student/studentLogin.jsp" style="right:-822px">学生登录</a></li>
				<li><a href="${pageContext.request.contextPath}/teacher/teacherLogin.jsp" style="right:-822px">教师登录</a></li>
				<li><a href="${pageContext.request.contextPath}/admin/adminLogin.jsp" style="right:-822px">管理员登录</a></li>
	       		<%--<li class="dropdown">
